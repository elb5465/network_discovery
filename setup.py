...
setup(
    ...
    description='Scan the user\'s network to retrieve all connected device\'s IP/MAC addresses, FQDNs, and vendor names. This information is then sorted and exported to a JSON file in the directory that this is run in.',
